 ...
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 5,
   "id": "db80de6c-07c2-40a2-a3f1-09bf5c2737e9",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
   ...
   "source": [
    ...
    "    with col211:\n",
    "        slider_week = st.slider(\"주간\", min_value=min_date, max_value=min_date,\n",
    "                                step=datetime.timedelta(weeks=1), value=(min_date,now_date2))\n",
    "    with col212:\n",
    "        slider_month = st.slider(\"월간\", min_value=min_date, max_value=min_date,\n",
